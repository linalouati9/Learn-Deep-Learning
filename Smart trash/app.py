...
def predict(upload):
    ...
    img_resize = np.expand_dims(img_resize, axis=0) # Mettre l'image dans un batch d'un seul élèment puisque le model attend un batch 
...
upload = st.file_uploader("Chargez l'image de l'objet",
                          type=["png", "jpeg", "jpg"])
